...
//   const activityLevelRef = useRef<HTMLDivElement>(null);
//   const primaryGoalsRef = useRef<HTMLDivElement>(null);
//   const mealPrepExperienceRef = useRef<HTMLSelectElement>(null);
//   const cookingSkillsRef = useRef<HTMLSelectElement>(null);
//   const budgetRangeRef = useRef<HTMLSelectElement>(null);
//   const servicesInterestedRef = useRef<HTMLDivElement>(null);
//   const preferredDateRef = useRef<HTMLInputElement>(null);
//   const preferredTimeRef = useRef<HTMLSelectElement>(null);
//   const timeZoneRef = useRef<HTMLSelectElement>(null);
//   const communicationPreferenceRef = useRef<HTMLSelectElement>(null);
...
//                     <div ref={servicesInterestedRef} className="space-y-4">
...
//               >
//                 <div className="space-y-6">
//                   {/* Mobile step content would mirror desktop but optimized for mobile */}
//                   {currentStep === 1 && (
//                     <div className="space-y-4">
...
//                                     {service.name}
//                                     {service.required && (
//                                       <span className="text-xs bg-orange-100 text-orange-600 px-2 py-1 rounded-full ml-1">
//                                         Required
//                                       </span>
//                                     )}
//                                   </h3>
...
//                               </a>
//                               . I understand that the consultation fee is $
//                               {(calculateTotal() || 0).toFixed(2)} and
...
//                           />
//                           <span className="text-xs text-gray-700">
//                             I would like to receive health tips, nutrition
//                             advice, and promotional offers via email. (Optional)
//                           </span>
//                         </label>
//                       </div>
//                     </div>
...
//                     <div className="space-y-4">
//                       <div className="text-center mb-6">
//                         <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-emerald-500 to-green-600 rounded-full mb-4">
