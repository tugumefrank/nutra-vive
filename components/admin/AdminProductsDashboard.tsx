...
//   const calculateStats = (): IProductStats => {
//     return {
...
//       ).length,
//       revenue: products.reduce((sum, p) => sum + p.price * 10, 0), // Mock revenue calculation
//     };
//   };
...
//   const StatsCard: React.FC<IStatCard> = ({
//     icon: Icon,
//     title,
//     value,
//     subtitle,
...
//                 <select className="px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all">
