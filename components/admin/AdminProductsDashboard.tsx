              ...
              <div className="flex items-start justify-between mb-1">
                ...
                <div className="relative">
                  <button
                    onClick={() =>
                      setOpenMobileMenu(
                        openMobileMenu === product._id ? null : product._id
                      )
                    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 lg:gap-4">
              ...
              <button
                ...
                className="px-4 lg:px-6 py-2 lg:py-3 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition-all hover:scale-105 hover:shadow-lg flex items-center gap-2 text-sm lg:text-base"
              >
                <FolderPlus className="h-4 lg:h-5 w-4 lg:w-5" />
                <span className="hidden sm:inline">Add Category</span>
                <span className="sm:hidden">Category</span>
              </button>
              <button
                onClick={() => setShowAddProduct(true)}
                className="px-4 lg:px-6 py-2 lg:py-3 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-all hover:scale-105 hover:shadow-lg flex items-center gap-2 text-sm lg:text-base"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 py-6 lg:py-8">
        ...
        {/* Controls */}
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 p-4 lg:p-6 mb-6 lg:mb-8">
        ...
        {/* Pagination */}
        {totalPages > 1 && (
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 lg:mt-8 bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 p-4 lg:p-6">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => setCurrentPage(currentPage - 1)}
                disabled={currentPage === 1}
                className="px-3 lg:px-4 py-2 border border-gray-300 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 transition-colors text-sm"
              >
                Previous
              </button>
                ...
                {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                  ...
                  return (
                    <button
                      key={pageNum}
                      onClick={() => setCurrentPage(pageNum)}
                      className={`px-2 lg:px-3 py-2 rounded-lg transition-colors text-sm ${
                        currentPage === pageNum
                          ? "bg-emerald-600 text-white"
                          : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                      }`}
