...
// }> = ({ consultation, onView, onUpdateStatus }) => {
...
//   return (
//     <div
//       className={`bg-white rounded-xl shadow-sm border-l-4 ${getUrgencyColor(
...
//           <span>{consultation.servicePreferences.preferredDate}</span>
//         </div>
//         <div className="flex items-center gap-2 text-sm text-gray-600">
...
//             className="px-3 py-1 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm transition-colors flex items-center gap-1"
//           >
...
//   const handleAddNote = () => {
//     if (newNote.trim()) {
//       onAddNote(consultation._id, newNote);
//       setNewNote("");
...
//               Consultation Details - #{consultation.consultationNumber}
//             </h2>
//             <button
//               onClick={onClose}
...
//                 <p className="text-gray-900">{consultation.personalInfo.age}</p>
//               </div>
//               <div>
//                 <label className="text-sm font-medium text-gray-600">
//                   Email
...
//                   </label>
//                   <p className="text-gray-900">
//                     {consultation.healthInfo.currentWeight} lbs
//                   </p>
//                 </div>
//                 <div>
//                   <label className="text-sm font-medium text-gray-600">
...
//                   </label>
//                   <p className="text-gray-900">
//                     {consultation.healthInfo.goalWeight} lbs
//                   </p>
//                 </div>
//                 <div>
//                   <label className="text-sm font-medium text-gray-600">
...
//                       <span
//                         key={index}
//                         className="px-2 py-1 bg-emerald-100 text-emerald-700 text-sm rounded-md"
//                       >
//                         {goal}
//                       </span>
//                     )
...
//                       <span
//                         key={index}
//                         className="px-2 py-1 bg-yellow-100 text-yellow-700 text-sm rounded-md"
//                       >
//                         {service}
//                       </span>
//                     )
...
//                 <p className="text-gray-900">{consultation.additionalNotes}</p>
//               </div>
//             </section>
//           )}
...
//                 className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg text-sm transition-colors flex items-center gap-2"
//               >
...
//                   Initial consultation completed. Client is highly motivated and
//                   has clear goals. Recommended starting with a 7-day meal plan
//                   focusing on portion control and increased vegetable intake.
//                 </p>
//               </div>
//             </div>
//           </section>
...
//         },
//         goalsAndLifestyle: {
//           primaryGoals: ["Weight Loss", "Improved Energy", "Better Digestion"],
//           motivationLevel: 8,
//           budgetRange: "100-150",
//         },
//         servicePreferences: {
//           servicesInterested: ["consultation", "meal-plan"],
//           preferredDate: "2024-01-15",
//           preferredConsultationTime: "14:00",
...
//         additionalNotes:
//           "Looking forward to starting my health journey. I work long hours and need practical meal solutions.",
//       },
//       {
//         _id: "2",
//         consultationNumber: "CONS-000002",
//         personalInfo: {
//           firstName: "Marcus",
//           lastName: "Johnson",
...
//         },
//         servicePreferences: {
//           servicesInterested: ["consultation", "coaching"],
//           preferredDate: "2024-01-12",
//           preferredConsultationTime: "10:00",
...
//         additionalNotes:
//           "Recent blood work shows elevated glucose levels. Want to prevent diabetes progression.",
//       },
//     ];
...
//     // In real implementation, this would call an API to save the note
//     console.log("Adding note to consultation:", consultationId, note);
//   };
