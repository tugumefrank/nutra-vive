...
// Mock functions for demo - ONLY CHANGED THE IMAGE URLS
const getCart = async () => ({
  success: true,
  cart: {
    _id: "cart123",
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100">
      ...
      <div className="container mx-auto px-4 py-4 md:py-8">
        <div className="grid lg:grid-cols-3 gap-4 md:gap-8">
          {/* Cart Items Section */}
          <div className="lg:col-span-2 space-y-4 md:space-y-6">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl md:rounded-3xl p-4 md:p-6 border border-white/20">
              <div className="flex items-center justify-between mb-4 md:mb-6">
                <h2 className="text-lg md:text-xl font-semibold flex items-center">
                  <ShoppingBag className="w-5 h-5 mr-2 text-orange-600" />
                  Cart Items
              ...
              <div className="space-y-3 md:space-y-4">
                {cart.items.map((item, index) => (
                  <div
                    ...
                    className="flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-white/60 rounded-xl md:rounded-2xl border border-white/40 hover:bg-white/80 transition-all"
                  >
                    {/* Product Image - ONLY THIS PART CHANGED */}
                    ...
                    <div className="flex flex-col items-end gap-2">
                      ...
                      <div className="text-right">
                        ...
                        <button
                          ...
                          disabled={updatingItems.has(item._id)}
                          className="text-red-500 hover:text-red-700 hover:bg-red-50 h-auto p-1 mt-1 rounded transition-colors disabled:opacity-50"
                        >
                          <X className="w-3 h-3 md:w-4 md:h-4" />
                        </button>
                      </div>
          ...
          {/* Cart Total Section */}
          <div className="space-y-4 md:space-y-6">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl md:rounded-3xl p-4 md:p-6 border border-white/20 sticky top-24">
              <h2 className="text-lg md:text-xl font-semibold mb-4 md:mb-6 flex items-center">
                <Gift className="w-5 h-5 mr-2 text-orange-600" />
                Order Summary
              </h2>
